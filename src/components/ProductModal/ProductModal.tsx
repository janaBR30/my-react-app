import { Button, Form, FormLabel, Modal, ModalTitle } from "react-bootstrap";
...
const ProductModals = ({show, onHide, title, modalType, prod, refreshData}: ProductModalProps) => {
    ...
    const validationSchema = () => {
        return Yup.object().shape({
            ...
            description: Yup.string().min(0).required('La descrpcion es requerida'),
            category: Yup.string().required('La categoria es requerida'),
            image: Yup.string().required('La URL de la imagen es requerida'),
        });
    };

    //Formik, utiliza el esquema de validacion para crear un formulario dinamico y que 
    //bloquee en caso de haber errores.
        ...
        <Modal show={show} onHide={onHide} centered backdrop="static" className="modal-xl">
            ...
            <Modal.Body>
                <Form onSubmit= {formik.handleSubmit}>
                    {/*Form.Group por cada campo para dar el alta o modificar un producto*/}
